...
My current focus is on **AI, Machine Learning, and Vision Systems**—building models that help machines interpret and understand the visual world.
...
- 👁️ Image classification, object detection, segmentation  
- 🤖 Real-time video processing with OpenCV  
- 📦 Complete CV pipelines: preprocessing → model training → inference  
